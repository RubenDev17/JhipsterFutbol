...
import { PresidenteComponent } from 'app/entities/presidente/presidente.component';
...
describe('Component Tests', () => {
  describe('Presidente Management Component', () => {
    let comp: PresidenteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PresidenteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.presidentes && comp.presidentes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
