...
import { JugadorComponent } from 'app/entities/jugador/jugador.component';
...
describe('Component Tests', () => {
  describe('Jugador Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.jugadors && comp.jugadors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
