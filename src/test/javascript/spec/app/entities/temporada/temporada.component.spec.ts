...
import { TemporadaComponent } from 'app/entities/temporada/temporada.component';
...
describe('Component Tests', () => {
  describe('Temporada Management Component', () => {
    let comp: TemporadaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TemporadaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.temporadas && comp.temporadas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
