...
import { DatoComponent } from 'app/entities/dato/dato.component';
import { DatoService } from 'app/entities/dato/dato.service';
import { Dato } from 'app/shared/model/dato.model';

describe('Component Tests', () => {
  describe('Dato Management Component', () => {
    let comp: DatoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DatoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.datoes && comp.datoes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
