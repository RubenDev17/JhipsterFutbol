...
export class PartidoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.partidoService
        ...
        .subscribe(
          (res: HttpResponse<IPartido[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  protected onSuccess(data: IPartido[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
