...
export class EquipoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.equipoService
        ...
        .subscribe(
          (res: HttpResponse<IEquipo[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  protected onSuccess(data: IEquipo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
