...
export class JugadorComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.jugadorService
        ...
        .subscribe(
          (res: HttpResponse<IJugador[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInJugadors(): void {
    this.eventSubscriber = this.eventManager.subscribe('jugadorListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IJugador[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
